//
//  BlueToothGCDManager.m
//  BLUETOOTHDOME
//
//  Created by 北辰青 on 2017/6/26.
//  Copyright © 2017年 北辰青. All rights reserved.
//

#import "BlueToothGCDManager.h"
@interface BlueToothGCDManager ()
@property (nonatomic, strong) NSMutableDictionary *timerContainer;
@property (nonatomic, strong) NSMutableDictionary *actionBlockCache;
@end
@implementation BlueToothGCDManager
#pragma mark - Public Method

+ (BlueToothGCDManager *)sharedInstance
{
    static BlueToothGCDManager *_gcdTimerManager = nil;
    static dispatch_once_t onceToken;
    
    dispatch_once(&onceToken,^{
        _gcdTimerManager = [[BlueToothGCDManager alloc] init];
    });
...
- (void)scheduledDispatchTimerWithName:(NSString *)timerName
                          ...
                          actionOption:(BlueToothActionOption)option
